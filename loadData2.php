...
$item = 0;
$files[$item]['fileName'] = "/home/brad/git/gcs/Library/Skills/Action.skl";
...
$item++;
$files[$item]['fileName'] = "/home/brad/git/gcs/Library/Skills/Basic Set.skl";
$files[$item]['xpath'] = 'skill';
...
$item++;
$files[$item]['fileName'] = "/home/brad/git/gcs/Library/Skills/High Tech.skl";
$files[$item]['xpath'] = 'skill';
...
$item++;
$files[$item]['fileName'] = "/home/brad/git/gcs/Library/Skills/Martial Arts.skl";
$files[$item]['xpath'] = 'skill';
...
$item++;
$files[$item]['fileName'] = "/home/brad/git/gcs/Library/Skills/Psionics.skl";
$files[$item]['xpath'] = 'skill';
...
//
//$item++;
//$files[$item]['fileName'] = "/home/brad/git/gcs/Library/Advantages/Basic Set.adq";
//$files[$item]['xpath'] = 'advantage';
//
//$item++;
//$files[$item]['fileName'] = "/home/brad/git/gcs/Library/Advantages/High Tech.adq";
//$files[$item]['xpath'] = 'advantage';
//
//$item++;
//$files[$item]['fileName'] = "/home/brad/git/gcs/Library/Advantages/Ultra Tech.adq";
//$files[$item]['xpath'] = 'advantage';
//
//$item++;
//$files[$item]['fileName'] = "/home/brad/git/gcs/Library/Advantages/Action.adq";
//$files[$item]['xpath'] = 'advantage';
//
//$item++;
//$files[$item]['fileName'] = "/home/brad/git/gcs/Library/Advantages/Martial Arts.adq";
//$files[$item]['xpath'] = 'advantage';
//
//$item++;
//$files[$item]['fileName'] = "/home/brad/git/gcs/Library/Advantages/Psionics.adq";
//$files[$item]['xpath'] = 'advantage';
//
//$item++;
//$files[$item]['fileName'] = "/home/brad/git/gcs/Library/Advantages/Dungeon Fantasy.adq";
//$files[$item]['xpath'] = 'advantage';
//
//
////
//$item++;
//$files[$item]['fileName'] = "/home/brad/git/gcs/Library/Equipment/Basic Set.eqp";
//$files[$item]['xpath'] = 'equipment';
//
//$item++;
//$files[$item]['fileName'] = "/home/brad/git/gcs/Library/Equipment/High Tech.eqp";
//$files[$item]['xpath'] = 'equipment';
//
//$item++;
//$files[$item]['fileName'] = "/home/brad/git/gcs/Library/Equipment/Ultra Tech.eqp";
//$files[$item]['xpath'] = 'equipment';
//
//$item++;
//$files[$item]['fileName'] = "/home/brad/git/gcs/Library/Equipment/Action.eqp";
//$files[$item]['xpath'] = 'equipment';
//
//$item++;
//$files[$item]['fileName'] = "/home/brad/git/gcs/Library/Equipment/Magic.eqp";
//$files[$item]['xpath'] = 'equipment';
//
//$item++;
//$files[$item]['fileName'] = "/home/brad/git/gcs/Library/Equipment/Dungeon Fantasy.eqp";
//$files[$item]['xpath'] = 'equipment';
//
//$item++;
//$files[$item]['fileName'] = "/home/brad/git/gcs/Library/Equipment/Mysteries.eqp";
//$files[$item]['xpath'] = 'equipment';
...
foreach($files as $file){
  if(file_exists($file['fileName'])){
    ...
    echo("Unable to locate file: " . $file['fileName'] . PHP_EOL);
  }
}
...
function loadData($file, $mysqli){
    ...
    echo('Loading: ' . $source . "\tClass: " . $xpath . PHP_EOL);
...
//        }
//        $sql  = "INSERT INTO gurps.items (class,item_name,source,specialization,canonical_name,points,reference,difficulty,type,base_points,quantity,tech_level,legality_class,value,notes,levels,cr,points_per_level,weight,long_description) ";
...
//                    }
//                    $sql  = "INSERT INTO gurps.defaults (itemID_fk,type,name,modifier,specialization) ";
...
//                    }
//                    $sql  = "INSERT INTO gurps.categories (itemID_fk,category) ";
...
//                    }
//                    $sql  = "INSERT INTO gurps.modifiers (itemID_fk,name,affects,reference,notes) ";
...
//                    }
//                    $sql  = "INSERT INTO gurps.bonuses (itemID_fk,class,name,amount) ";
...
//                        $bon_amount = $item->xpath("amount")[0] . "";
//                    }
//                    $sql  = "INSERT INTO gurps.bonuses (itemID_fk,class,name,specialization,amount) ";
...
//                        $bon_amount = $item->xpath("amount")[0] . "";
//                    }
//                    $sql  = "INSERT INTO gurps.bonuses (itemID_fk,class,attribute,amount) ";
...
//                        }
//                        $sql  = "INSERT INTO gurps.prerequisites (itemID_fk,class,name,notes,specialization,level) ";
...
//        }
    ...
    echo("Loaded Items: $oloop" . PHP_EOL);
}
$mysqli->close();
?>
